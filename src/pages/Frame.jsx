...
const Frame = () => {
  ...
  return (
    <div className="w-full relative bg-gradient-to-br from-sage-100 via-cream-200 to-pine-100 flex flex-col items-center min-h-screen text-left text-[1.25rem] font-inter">
